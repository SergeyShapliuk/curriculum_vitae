        ...
        <div className={s.skillsBlock}>
            <div className={`${styleContainer.container} ${s.skillsContainer}`}>
                ...
                <div className={s.skills}>
                    ...
                    <Skill style={axios} title={'Axios'} description={'Axios-это библиотека Javascript, используемая для выполнения HTTP-запросов от node.js или XMLHttpRequests из браузера, который также поддерживает API ES6 Promise. Отлично, из этого мы заключаем, что он делает то, что мы уже можем сделать, и что в последнее время стало значительно лучше…'}/>
